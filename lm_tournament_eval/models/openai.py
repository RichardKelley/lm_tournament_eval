...
import lm_tournament_eval.models.utils
from lm_tournament_eval import utils
from hflm import LM
from hflm.utils import get_batches
from lm_tournament_eval.api.registry import register_model
from lm_tournament_eval.models.utils import (
...
class OpenaiCompletionsLM(LM):
    ...
    def _loglikelihood_tokens(
        ...
        for chunk in tqdm(
            ...
            get_batches(requests, n=self.batch_size),
    ...
    def generate_until(self, requests, disable_tqdm: bool = False) -> List[str]:
        ...
        for chunk, request_args in tqdm(
            ...
            sameuntil_chunks(requests, self.batch_size),
            disable=disable_tqdm,
        ):
            inps = []
...
class OpenaiChatCompletionsLM(LM):
    ...
    def generate_until(self, requests, disable_tqdm: bool = False) -> List[str]:
        ...
        for key, re_ord in re_ords.items():
            ...
            chunks = get_batches(re_ord.get_reordered(), n=1)
            for chunk in chunks:
